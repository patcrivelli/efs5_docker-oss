...
class ApplicationData(BaseApplicationData):
    class Meta:
        db_table = "efs_finance_applicationdata"

class tf_ApplicationData(BaseApplicationData):
    class Meta:
        db_table = "efs_finance_tf_applicationdata"

class scf_ApplicationData(BaseApplicationData):
    class Meta:
        db_table = "efs_finance_scf_applicationdata"

class IPF_ApplicationData(BaseApplicationData):
    class Meta:
        db_table = "efs_finance_ipf_applicationdata"
