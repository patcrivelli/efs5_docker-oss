...
# -------------------------
# Concrete models (Trade Finance)
# -------------------------
class tf_TransactionLedger(BaseTransactionLedger):
    class Meta:
        db_table = "efs_lms_tf_transactionledger"


class tf_TransactionDetails(BaseTransactionDetails):
    class Meta:
        db_table = "efs_lms_tf_transactiondetails"


class tf_InvoiceRepayments(BaseInvoiceRepayments):
    class Meta:
        db_table = "efs_lms_tf_invoicerepayments"


class tf_DrawdownData(BaseDrawdownData):
    class Meta:
        db_table = "efs_lms_tf_drawdowndata"


class tf_Drawdown(BaseDrawdown):
    class Meta:
