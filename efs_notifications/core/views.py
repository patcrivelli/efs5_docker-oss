# efs_notifications/core/views.py
import logging
import requests
...
def notifications_home(request):
    return render(request, "notifications_home.html", base_context(request))

def notifications_view(request):
    return render(request, "notifications.html", base_context(request))
...
def create_originator(request):
    ...
    return redirect("notifications_home")
