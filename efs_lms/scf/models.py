...
# -------------------------
# Concrete models (Supply Chain Finance)
# -------------------------
class scf_TransactionLedger(BaseTransactionLedger):
    class Meta:
        db_table = "efs_lms_scf_transactionledger"


class scf_TransactionDetails(BaseTransactionDetails):
    class Meta:
        db_table = "efs_lms_scf_transactiondetails"


class scf_InvoiceRepayments(BaseInvoiceRepayments):
    class Meta:
        db_table = "efs_lms_scf_invoicerepayments"


class scf_DrawdownData(BaseDrawdownData):
    class Meta:
        db_table = "efs_lms_scf_drawdowndata"


class scf_Drawdown(BaseDrawdown):
    class Meta:
        db_table = "efs_lms_scf_drawdown"
